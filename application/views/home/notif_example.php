  ...
  <script>
    $(function () {
      ...
      //     // navigator.serviceWorker.register('<?php echo base_url() ?>assets/push-notif/serviceWorker.min.js');
      //     navigator.serviceWorker.register('<?php echo base_url() ?>assets/push-notif/sw.js');
      // };

      Push.config({
        serviceWorker: '<?php echo base_url() ?>assets/push-notif/serviceWorker.min.js', // Sets a custom service worker script
