...
<div id="content" class="container-fluid">
   <h4>Monitoring Status Activity On <?php echo $data_date ?></h4>
  <hr/>

  <div class="alert alert-info">
    <h6 class="font-weight-bold"><i class="fas fa-info-circle"></i> Click the name to see personal performance.</h6>
    <a href="<?php echo base_url() ?>home\summary_manhours_user_date\<?php echo $utc ?>" class="btn btn-sm btn-info">View Summary Man Hours</a>
  </div>
              ...
              <tbody>
                ...
                <?php foreach ($data_user['Drafter'] as $row) { ?>
                  <tr>
                    ...
                    <td><?php echo $row['NDT'] ?></td>
                    <td><?php echo $row['PC&MS'] ?></td>
                  </tr>
                <?php } ?>
                <?php endif; ?>
              </tbody>
            ...
            <table class="table table-hover text-center dataTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $row['gallaf'] ?></td>
                  <td><?php echo $row['formosa'] ?></td>
                </tr>
              <?php } ?>
              <?php endif; ?>
              </tbody>
