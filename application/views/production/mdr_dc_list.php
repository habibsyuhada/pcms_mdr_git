                ...
                <div class="col-md">
                  <div class="form-group row m-0">
                    <div class="col-xl text-right">
                      <a target="_blank" href="<?= base_url() ?>report/mdr_design_list_smop_excel3/<?php echo ($this->permission_eng_act[39] == '0' ? $this->user_cookie[10] : ($this->input->get('project_id') ? $this->input->get('project_id') : '')) ?>" class="btn btn-success text-white" ><i class="fas fa-file-alt"></i> SMOP MDR Report</a>
                      <!-- <button type="submit" name='submit' value='download' class="btn btn-info" title="Download"><i class="fa fa-download"></i> Download</button> -->
                      <!-- <a target="_blank" href="<?= base_url() ?>report/master_mdr_report_excel/010" class="btn btn-success text-white" ><i class="fas fa-file-alt"></i> SMOP MDR Report 2</a> -->
                      <!-- <a target="_blank" href="<?= base_url() ?>production/mdr_design_list_smop_excel2" class="btn btn-success text-white" ><i class="fas fa-file-alt"></i> SMOP MDR Report</a> -->
                      <!-- <a target="_blank" href="<?= base_url() ?>production/mdr_design_list_excel" class="btn btn-info text-white" ><i class="fa fa-download"></i> Download</a> -->
          ...
          <div class="container-fluid">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-4" style= "padding:0;">
                <form method="POST" id="form_delete" action="<?= site_url('production/multiple_delete_mdr') ?>">
                  <div class="font-weight-bold">
...
<script type="text/javascript">
  ...
  $('.dataTable').DataTable({
    ...
    "order": [],
    "ajax": {
      "url": "<?php echo base_url();?>production/mdr_design_list_json",
      "type": "POST",
      "data":{
          // "page" : 'list',
      <?php 
  ...
  function delete_data(id) {
    Swal.fire({
      ...
      if (result.value) {
        window.location = "<?php echo base_url() ?>production/delete_data_dc/2/"+id;
      }
    })
  }
