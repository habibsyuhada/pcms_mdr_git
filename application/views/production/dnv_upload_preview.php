<div id="content">
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <h6>DNV Preview Upload</h6>
            <hr>
            <form action="<?= site_url('production/process_submit_dnv') ?>" method="POST" id="formDnv">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td><input type="text" name="ts_out_date[]"
                                                value="<?= $value['data']['D'] ? date('Y-m-d', strtotime($value['data']['D'])) : NULL ?>"
                                                id="" class="form-control"
                                                <?= $value['duplicate'] ? 'disabled' : 'readonly' ?>></td>
                                        ...
                                        <td><input type="text" name="ts_in_date[]"
                                                value="<?=  $value['data']['H'] ? date('Y-m-d', strtotime($value['data']['H'])) : NULL ?>"
                                                id="" class="form-control"
                                                <?= $value['duplicate'] ? 'disabled' : 'readonly' ?>></td>
                                        <td><input type="text" name="remarks[]" class="form-control remarks<?= $key ?>"
                                                value="<?= $value['data']['I'] ?>" id=""
                                                <?= $value['duplicate']   ? 'disabled' : 'readonly' ?>></td>
                                        <td class="text-center statustd">
...
$(document).ready(function() {
    ...
    console.log(total_data, total_not_found)
    $('#formDnv').submit(function(e) {
        e.preventDefault()
