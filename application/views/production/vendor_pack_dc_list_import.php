  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="pb-2 mb-0">Import Definition (VENDOR)</h6>
        <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
          <div class="container-fluid">
            <?php if($this->permission_eng_act[37] == '1'): ?>
            <form method="POST" action="<?php echo base_url();?>production/mdr_definition_import_preview/3"
    ...
    <div class="col-md-6">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="pb-2 mb-0">Import Document Status & Progress  (VENDOR)</h6>
        <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
          <div class="container-fluid">
            <?php if($this->permission_eng_act[37] == '1'): ?>
    ...
    <div class="col-md-6">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="pb-2 mb-0">Import MWS (VENDOR)</h6>
        <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
          <div class="container-fluid">
            <?php if($this->permission_eng_act[37] == '1'): ?>
    ...
    <div class="col-md-6">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="pb-2 mb-0">Import CA-DNV  (VENDOR)</h6>
        <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
          <div class="container-fluid">
            <?php if($this->permission_eng_act[37] == '1'): ?>
    ...
    <div class="col-md-12">
    <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="pb-2 mb-0">Import Planner  (VENDOR)</h6>
    <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
      <div class="container-fluid">
      <?php if($this->permission_eng_act[37] == '1'): ?>
      <form method="POST" action="<?php echo base_url();?>production/planner_upload_preview"
        ...
        <div class="col-md">
          ...
          <div class="col-xl">
            <div class="col-xl text-right">
            <a href="<?php echo base_url(); ?>file/production_design/Template_Import_Planner.xlsx"
              class='btn btn-success'><i class="fas fa-cloud-download-alt"></i>
              Download Template Planner 
              <?php if(date('Y-m-d') < '2020-09-15'): ?><span
              class="badge badge-danger">New</span><?php endif; ?></a>
            </div>
          </div>
