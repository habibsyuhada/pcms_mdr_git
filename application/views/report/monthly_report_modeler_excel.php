...
<table border="1" style="">
  <thead>
    ...
    <tr>
      ...
      <th style="background: #28a745; color: white;text-align: center;">AL-SHAHEEN GALLAF</th>
      <th style="background: #28a745; color: white;text-align: center;">FORMOSA 2</th>
    </tr>
  </thead>
  <tbody>
    ...
    <?php else: ?>
      ...
      ?>
        <tr>
          <td style="text-align: left;" nowrap><?php echo $user_design_list[$data['id_user']]; ?></td>
          <td style="text-align: center;" nowrap>Modeler</td>
          <td style="text-align: center;" nowrap><?php echo $func->convert_to_time_format($data['gallaf']) ?></td>
          <td style="text-align: center;" nowrap><?php echo $func->convert_to_time_format($data['formosa']) ?></td>
        </tr>
      <?php endforeach; endif;?>
    <?php endif; ?>
  </tbody>
