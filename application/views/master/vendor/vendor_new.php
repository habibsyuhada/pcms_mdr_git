<div id="content" class="container-fluid">
  <form method="POST" action="<?php echo base_url();?>m_vendor/vendor_new_process">
    <div class="row">
          ...
          <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
            <div class="container-fluid">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="company_code_check(this);" name="company_code" placeholder="Code Vendor">                
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="company_name_check(this);" name="company_name" placeholder="Description Vendor">                
                </div>
              </div>
