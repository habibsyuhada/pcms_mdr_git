...
<div id="content" class="container-fluid">
  <form method="POST" action="<?php echo base_url();?>m_drawing_type/drawing_type_edit_process">
    <div class="row">
          ...
          <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
            <div class="container-fluid">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="code_check(this);" name="code" placeholder="Code Drawing Type" value="<?php echo $dt['code'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="description_check(this);" name="description" placeholder="Description Drawing Type" value="<?php echo $dt['description'] ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="checkbox" class="checkbox-big form-control m-2" name="refer_ga" value="1"  <?php echo ($dt['refer_ga'] == '1' ? 'checked' : '') ?>>
                </div>
              </div>
