          ...
          <div class="container-fluid">
            <div class="tab-content">
              ...
              <div class="tab-pane fade <?php echo ($t == '' ? 'show active' : '') ?>" id="pills-activity">
                <form method="POST" action="<?php echo base_url();?>mockup/activity_detail_progress">
                  <div class="row">
                    ...
                    <div class="col-md">
                      <div class="form-group row">
                        <div class="col-xl text-center">
                          <button type="submit" name='submit' value='submit' class="btn btn-success btn-lg"><i class="fa fa-play"></i> <b>START</b></button>
                        </div>
                      </div>
                    </div>
                  </div>
